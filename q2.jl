...
# ╔═╡ 953eb85e-350c-11ed-2ac5-51cec1febe6e
using Yao

# ╔═╡ fe8f1329-053f-40f1-adfa-80a80999d671
using YaoPlots

# ╔═╡ d155d07e-98f2-48df-b7d6-99b0621cfdbb
function smallest_entangler(n)
	C = chain(n, put(1 => H))
	for layer in 1:ceil(Int, log(2, n))
		for c in 1:2^(layer-1)
			if c <= n && 2^(layer-1)+c <= n
				C = chain(C, control(n, c, 2^(layer-1)+c => X))
			else
				break
			end
		end
	end
	plot(C), 1+ceil(Int, log(2,n))
end

# ╔═╡ fc74b3b7-880c-40cf-8125-ce9361c75e45
s = smallest_entangler(5);

# ╔═╡ 32506073-f711-4a72-9765-602fa3e03b59
begin
	YaoPlots.darktheme!()
	s[1]
end

# ╔═╡ 0ca46e53-f41b-4464-80d7-48154cdad5fd
md"""### Circuit depth = $(s[2])"""
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "44e40010ee595a38a3f423861c8fcdd295cffcee"
...
git-tree-sha1 = "2c8959cbf575101dd300d8128fba0c04d09c77e7"
uuid = "5872b779-8223-5990-8dd0-5abbb0748c8c"
version = "0.8.4"

[[deps.YaoAPI]]
git-tree-sha1 = "4fe71d64b0144a99abf3b2b1ee59bea4b65911c1"
...
git-tree-sha1 = "b7a87f77aae4caa47fae981aad3c8a1507d64683"
...
git-tree-sha1 = "11d4d9faef1a1a501e3fa985085115ac18d6eb43"
...
git-tree-sha1 = "f5b64278bc3a0a0392b8b946341cd51571b17303"
